...
set_appearance_mode("System") # Setting the appearance mode to: "System", "Light" or "Dark"
set_default_color_theme("blue") # Setting the theme of the app
...
def download_video(entry_field):
    try:
        ...
        popup.mainloop()
    except exceptions.RegexMatchError: # If there's an invalid link or empty link, show an error 
        error = CTk()
        error.title("Error")
